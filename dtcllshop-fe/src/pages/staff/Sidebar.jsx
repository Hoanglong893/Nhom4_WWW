    ...
    return (
        <div className="fixed left-0 top-0 w-64 h-screen bg-gray-900 text-white p-6 flex flex-col z-50">
            ...
            <nav className="flex-1 space-y-2">
                ...
                <Link
                    to="/staff/orders"
                    className={`flex items-center gap-3 px-4 py-3 rounded-lg transition ${isActive("/staff/orders")
                ...
                <Link
                    to="/staff/invoices"
                    className={`flex items-center gap-3 px-4 py-3 rounded-lg transition ${isActive("/staff/invoices")
                            ? "bg-red-500 text-white"
                            : "text-gray-300 hover:bg-gray-800"
                        }`}
                >
